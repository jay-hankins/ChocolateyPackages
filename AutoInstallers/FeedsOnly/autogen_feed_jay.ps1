...
$items = @("GoogleChrome", "Firefox", "skype", "vlc", "k-litecodecpackbasic", "flashplayerplugin", "javaruntime", "DotNet4.5", "utorrent", "dropbox", "jdk8", "7zip.install", "python", "eclipse-standard-luna", "notepadplusplus.install", "cyg-get default", "iTunes",  "paint.net", "picasa", "Silverlight", "spotify", "teamviewer", "FoxitReader", "putty", "winscp", "brackets", "crashplan", "Office365HomePremium","JayHankins.ConEmuConfig")
...
$file = ([system.environment]::getenvironmentvariable("userprofile") + "\packages_jay.config")
$xml | out-File $file
